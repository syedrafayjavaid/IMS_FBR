...
const Department = () => {
    ...
    const getAlldata = () => {
      axios.get(`${config.base_url}/api/v1/department`).then((res) => {
    ...
    const createHandler = () => {
          ...
          axios.post(`${config.base_url}/api/v1/department`, data).then((res) => {
            if (res) {
              getAlldata();
              handleCreateClose()
      ...
      const editHandler = () => {
        let data = new FormData();
          ...
          axios.put(`${config.base_url}/api/v1/department/${brandId}`, data).then((res) => {
            console.log(res.msg);
            if (res) {
              getAlldata();
              handleEditClose()
                ...
                <DepartmentTable>
                    ...
                    <TableBody>
                        {brand.map((brand, index) => (
                            <DepartmentCard key={index} brand={brand} onEdit={onEdithandler} onDelete={onDelhandler} />
                        ))}
                    </TableBody>
                </DepartmentTable>
            </Box>
